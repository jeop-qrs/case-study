...
void searchNumber()
{
    ...
    do
    {
        ...
        while (1)
        {
            ...
            if (strlen(choice) != 1)
            {
                printf("Invalid input! Please only enter one character (Y or N)\n");
                continue;
            }

            if (!isalpha(choice[0])) 
            {
                printf("Invalid input! Please enter a valid alphabetic letter (Y or N)\n");
                continue;
            }

            char upper = toupper(choice[0]);
